...
def dollm(text):
    ...
    prompt = PromptTemplate.from_template(
        "using creative inspriation and wisdom and courage, Interpret this following graph extracted from ctuning.org and create a captivating narrative : {text}?"
    )
